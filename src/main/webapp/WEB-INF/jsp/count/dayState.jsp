...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据统计 <span class="c-gray en">&gt;</span> 当日数据统计 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
  <form action="/count/getDayStateList.action" method="get">
  <div class="text-c">
...
<script type="text/javascript">
    ...
    function pageNavCallBack(clickpage){
        window.location.href = "${pageContext.request.contextPath}/count/getDayStateList.action?page="+(clickpage - 1)+"&rows=10&coin="+$("#coin").val();
    }
</script>
</body>
</html>
