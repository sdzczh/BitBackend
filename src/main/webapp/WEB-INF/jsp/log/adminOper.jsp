...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 日志管理 <span class="c-gray en">&gt;</span> 管理员操作日志 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
  <form action="/log/getBackLogList.action" method="get">
  <div class="text-c">
    日期范围：
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="输入操作名" id="oper" name="oper" value="${oper}">
...
<script>
    ...
    function pageNavCallBack(clickpage){
        window.location.href = "${pageContext.request.contextPath}/log/getBackLogList.action?page="+(clickpage - 1)+"&rows=10&" +
            "datemin="+$("#datemin").val()+
                "&datemax="+$("#datemax").val()+
              "&oper="+$("#oper").val();
    }
