...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 日志管理 <span class="c-gray en">&gt;</span> 用户登录日志 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
  <form action="/log/getUserloginLogList.action" method="get">
  <div class="text-c">
    日期范围：
...
<script>
    ...
    function pageNavCallBack(clickpage){
        window.location.href = "${pageContext.request.contextPath}/log/getUserloginLogList.action?page="+(clickpage - 1)+"&rows=10&" +
            "datemin="+$("#datemin").val()+
            "&datemax="+$("#datemax").val();
    }
</script>
